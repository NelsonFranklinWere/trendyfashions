...
export const mainCategories: MainCategory[] = [
  {
    ...
    subcategories: [
      // A. Official Shoes
      {
        ...
        name: 'Dress Shoes',
        slug: 'dress-shoes',
        href: '/collections/officials?filter=Dress Shoes',
      ...
      },
      {
        ...
        href: '/collections/officials?filter=Leather Loafers',
        parentCategory: 'mens-shoes',
      },
      {
        id: 'oxford-derby',
        name: 'Oxford / Derby',
        slug: 'oxford-derby',
        href: '/collections/officials?filter=Oxford',
        parentCategory: 'mens-shoes',
      },
      {
        id: 'clarks-official',
      ...
      // B. Casual Shoes
      {
        ...
        name: 'Canvas',
        slug: 'canvas',
        href: '/collections/casuals?filter=Canvas',
        parentCategory: 'mens-shoes',
      },
      {
        id: 'slip-ons',
        name: 'Slip-Ons',
        slug: 'slip-ons',
        href: '/collections/casuals?filter=Slip-Ons',
        parentCategory: 'mens-shoes',
      },
      {
        id: 'clarks-casual',
        name: 'Clarks Casual',
        slug: 'clarks-casual',
        href: '/collections/casuals?filter=Clarks',
        parentCategory: 'mens-shoes',
      },
      {
        id: 'weekend-casuals',
      ...
      // D. Sports & Running
      {
        ...
        name: 'Running Shoes',
        slug: 'running-shoes',
        href: '/collections/airmax?filter=Running',
        parentCategory: 'mens-shoes',
      },
      {
        id: 'training-gym',
      ...
      // E. Boots (Men)
      {
        ...
        name: 'Timberland',
        slug: 'timberland',
        href: '/collections/casuals?filter=Timberland',
        parentCategory: 'mens-shoes',
      },
      {
        id: 'dr-martens',
        name: 'Dr. Martens',
        slug: 'dr-martens',
        href: '/collections/casuals?filter=Dr. Martens',
        parentCategory: 'mens-shoes',
      },
      {
        id: 'combat-boots',
        name: 'Combat Boots',
        slug: 'combat-boots',
        href: '/collections/casuals?filter=Combat',
        parentCategory: 'mens-shoes',
      },
      {
        id: 'chelsea-boots',
        name: 'Chelsea Boots',
        slug: 'chelsea-boots',
        href: '/collections/casuals?filter=Chelsea',
        parentCategory: 'mens-shoes',
      },
      // F. Air Collection
      {
    ...
    subcategories: [
      {
        ...
        href: '/collections/sneakers?gender=Unisex',
      ...
      },
      {
        ...
        name: 'Unisex Sports',
        slug: 'unisex-sports',
        href: '/collections/sports?gender=Unisex',
        parentCategory: 'unisex-collection',
      },
      {
        id: 'unisex-casual',
        name: 'Unisex Casual',
        slug: 'unisex-casual',
        href: '/collections/casuals?gender=Unisex',
        parentCategory: 'unisex-collection',
      },
    ],
  },
