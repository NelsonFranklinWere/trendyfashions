...
export const getStaticProps: GetStaticProps<HomeProps> = async () => {
  try {
    ...
    const { slimProductList } = await import('@/lib/server/slimProductProps');
    const pack = (list: Product[], n: number) => slimProductList(shuffle(list).slice(0, n));

    return {
      props: {
        featuredOfficials: pack(officials, 8),
        featuredClarks: pack(clarks, 8),
        featuredCasuals: pack(casuals, 8),
        featuredLacosteCasuals: pack(lacosteCasuals, 8),
        featuredTimberlandCasuals: pack(timberlandCasuals, 8),
        featuredOfficialCasuals: pack(officialCasuals, 8),
        featuredLoafers: pack(loafers, 10),
        featuredEmpireOfficials: pack(empireOfficials, 8),
        featuredOfficialBoots: pack(officialBoots, 8),
        featuredLacoste: pack(lacosteProducts, 8),
        featuredLoafersProducts: pack(loaferProducts, 8),
        featuredClarksOfficials: pack(clarksOfficials, 8),
        featuredEmpireOfficialsFiltered: pack(empireOfficialsFiltered, 8),
        featuredOfficialBootsFiltered: pack(officialBootsFiltered, 8),
        featuredTimberlandCasualsFiltered: pack(timberlandCasualsFiltered, 8),
        featuredOfficialCasualsFiltered: pack(officialCasualsFiltered, 8),
        featuredSports: pack(sports, 10),
        featuredVans: pack(vans, 10),
        featuredSandals: pack(sandals, 10),
        heroClarks: slimProductList(clarks),
        heroTimberland: slimProductList(timberland),
      },
    ...
    try {
      ...
      return {
        props: {
          ...
          featuredLoafersProducts: pack(loaferProducts, 8),
          featuredClarksOfficials: pack(clarksOfficials, 8),
          featuredEmpireOfficialsFiltered: pack(empireOfficials, 8),
          featuredOfficialBootsFiltered: pack(officialBoots, 8),
          featuredTimberlandCasualsFiltered: pack(timberlandCasuals, 8),
          featuredOfficialCasualsFiltered: pack(officialCasuals, 8),
          featuredSports: pack(sports, 10),
          featuredVans: pack(vans, 10),
          featuredSandals: pack(sandals, 10),
          heroClarks: slimProductList(clarks),
