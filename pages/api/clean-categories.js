...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Delete unwanted categories: airmax, jordan, airforce
    const categoriesToDelete = ['airmax', 'jordan', 'airforce'];
    ...
    return res.status(200).json({
      success: true,
      message: `Deleted ${imgDel.rowCount} images and ${prodDel.rowCount} products from categories: ${categoriesToDelete.join(', ')}`,
      remaining: {
