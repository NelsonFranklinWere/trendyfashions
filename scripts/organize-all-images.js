...
function moveFile(filePath, targetFolder) {
  ...
  if (fs.existsSync(targetPath)) {
    console.log(`⚠️  Skipping ${filename} - already exists in target folder`);
...
// Process all image files in public root
function organizeImages() {
  ...
  console.log(`📊 Found ${files.length} images in public root\n`);
