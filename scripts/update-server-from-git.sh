#!/bin/bash
# Quick Server Update Script - Run this directly on the server console
# Updates from latest git push, rebuilds, and restarts PM2

set -e

# Configuration (matches ecosystem.config.js)
