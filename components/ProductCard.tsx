  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="relative w-full h-48 sm:h-56 md:h-64 overflow-hidden bg-light cursor-pointer"
        ...
        >
          ...
          {product.tags?.includes('New Arrivals') && (
            <div className="absolute top-2 right-2 bg-secondary text-white px-3 py-1 rounded-full text-xs font-body font-semibold z-10">
              New
            </div>
          )}
